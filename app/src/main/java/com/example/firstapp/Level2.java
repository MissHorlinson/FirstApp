...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level2);  // Set level
        ...
        img_left.setImageResource(array.images2[numLeft]);  // Get picture from imgArr
        textLeft.setText(array.texts2[numLeft]);  // Get text from numArr
        ...
        img_right.setImageResource(array.images2[numRight]);  // Get picture from imgArr
        textRight.setText(array.texts2[numRight]);  // Get text from numArr
