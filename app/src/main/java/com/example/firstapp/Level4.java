...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level4);  // Set level
        ...
        textEnd.setText(R.string.levelfourEnd);
        ...
        img_left.setImageResource(array.images4[numLeft]);  // Get picture from imgArr
        textLeft.setText(array.texts4[numLeft]);  // Get text from numArr
        ...
        img_right.setImageResource(array.images4[numRight]);  // Get picture from imgArr
        textRight.setText(array.texts4[numRight]);  // Get text from numArr
